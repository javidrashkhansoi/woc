...
function click(event) {
  ...
  if (target.closest(".stores-preview__button")) {
    ...
    hideStores(!constants_root.classList.contains("burger-active") && !constants_root.classList.contains("dialog-active"));
  }
